...
// CChildFrame 消息处理程序
CMFCApplicationZcc1View* CChildFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CMFCApplicationZcc1View* pView = DYNAMIC_DOWNCAST(CMFCApplicationZcc1View, pWnd);
	return pView;
}
...
void CChildFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CMFCApplicationZcc1View* pView = GetRightPane(); 
...
void CChildFrame::OnViewStyle(UINT nCommandID)
{
	...
	// 如果右窗格已创建并且是 CMFCApplicationZcc1View，则处理菜单命令...
	if (pView != nullptr)
	{
		int nStyle = -1;
